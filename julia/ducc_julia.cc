...
void nufft_u2nu_julia_double (size_t ndim,
  ...
  u2nu<double,double>(mycoord,mygrid,forward,epsilon,nthreads,myout,verbosity,sigma_min,sigma_max);
  }
...
void nufft_nu2u_julia_double (size_t ndim,
  ...
  nu2u<double,double>(mycoord,mypoints,forward,epsilon,nthreads,myout,verbosity,sigma_min,sigma_max);
  }
