...
int main()
  ...
  nufft_u2nu_julia_double (ndim, npoints, shape, grid, coord, 1, 1e-5, 4, points, 1, 1.1, 2.5);
  nufft_nu2u_julia_double (ndim, npoints, shape, points, coord, 1, 1e-5, 4, grid, 1, 1.1, 2.5);
  }
